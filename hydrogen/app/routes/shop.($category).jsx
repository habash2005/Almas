...
export default function ShopPage() {
  ...
  const [activeCategory, setActiveCategory] = useState(
    urlCategory || searchParams.get('category') || 'all',
  );
  ...
  // Sync ?badge= search param (footer links to /shop?badge=Best+Seller)
  useEffect(() => {
  ...
  const filteredAndSorted = useMemo(() => {
    ...
    return result;
  }, [products, activeCategory, scentFamily, badgeFilter, sortBy]);
