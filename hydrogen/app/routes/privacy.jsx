        ...
        <div className="space-y-10">
          <div>
            ...
            <p className="text-sm text-warm-gray leading-relaxed mb-4">
              ALMAS Fragrance (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, make a purchase, or interact with our services.
            </p>
          ...
          <div>
            <h2 className="font-serif text-xl md:text-2xl font-light mb-4">9. Children&rsquo;s Privacy</h2>
            <p className="text-sm text-warm-gray leading-relaxed">
          ...
          <div>
            ...
            <p className="text-sm text-warm-gray leading-relaxed">
              We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the &ldquo;Last updated&rdquo; date. Your continued use of our website after any changes constitutes acceptance of the revised policy.
            </p>
          </div>
