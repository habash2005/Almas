      ...
      <section className="grid grid-cols-1 md:grid-cols-2 md:min-h-[70vh]">
        ...
        <div className="flex flex-col justify-center p-10 md:p-20">
          ...
          <p className="text-[15px] leading-[1.8] text-warm-gray max-w-[420px] mb-4 font-light">
            ALMAS was founded with a singular vision: to make the world&rsquo;s finest fragrance experiences accessible to everyone. The name &ldquo;Almas&rdquo; — meaning diamond in Arabic — reflects our belief that every person deserves to wear a scent that feels as precious and brilliant as a rare gem.
          </p>
          <p className="text-[15px] leading-[1.8] text-warm-gray max-w-[420px] font-light">
            Our master perfumers study the DNA of the world&rsquo;s most coveted luxury fragrances, then meticulously recreate them using premium ingredients sourced from the finest suppliers around the globe.
          </p>
        </div>
      </section>
      ...
      <section className="py-[120px] px-12 text-center">
        <div className="max-w-[600px] mx-auto">
          ...
          <p className="text-[15px] leading-[1.8] text-warm-gray font-light">
            Just as a diamond is shaped by precision and pressure, each ALMAS fragrance is the result of countless refinements. From the first burst of top notes to the lingering base, every layer has been carefully calibrated to create a scent that&rsquo;s as multifaceted and enduring as a precious stone.
          </p>
        </div>
      </section>
