        ...
        <div className="space-y-10">
          <div>
            ...
            <p className="text-sm text-warm-gray leading-relaxed mb-4">
              By accessing and using the ALMAS Fragrance website (&ldquo;Site&rdquo;), you agree to be bound by these Terms and Conditions (&ldquo;Terms&rdquo;), all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws.
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-warm-gray leading-relaxed mb-4">
              Permission is granted to temporarily access the materials on ALMAS Fragrance&rsquo;s website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-warm-gray leading-relaxed">
              We reserve the right to modify or replace these Terms at any time at our sole discretion. If a revision is material, we will provide at least 30 days&rsquo; notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion. Your continued use of the site after any changes constitutes acceptance of the new terms.
            </p>
          </div>
