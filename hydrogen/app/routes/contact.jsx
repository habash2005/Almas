    ...
    <>
      ...
      <section className="py-20 px-12 text-center bg-light-gray">
        ...
        <p className="text-[15px] text-warm-gray max-w-[460px] mx-auto font-light leading-[1.7]">
          We&rsquo;d love to hear from you. Whether you have a question about our fragrances, subscriptions, or anything else, our team is ready to help.
        </p>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 min-h-[70vh]">
        ...
        <div className="p-20">
          ...
          <p className="text-sm text-warm-gray mb-10">Fill out the form below and we&rsquo;ll get back to you within 24 hours.</p>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="contact-name" className="block text-[11px] tracking-[0.15em] uppercase text-warm-gray mb-2 font-sans">
                Full Name
              </label>
              <input
                id="contact-name"
            ...
            <div>
              <label htmlFor="contact-email" className="block text-[11px] tracking-[0.15em] uppercase text-warm-gray mb-2 font-sans">
                Email Address
              </label>
              <input
                id="contact-email"
            ...
            <div>
              <label htmlFor="contact-subject" className="block text-[11px] tracking-[0.15em] uppercase text-warm-gray mb-2 font-sans">
                Subject
              </label>
              <select
                id="contact-subject"
            ...
            <div>
              <label htmlFor="contact-message" className="block text-[11px] tracking-[0.15em] uppercase text-warm-gray mb-2 font-sans">
                Message
              </label>
              <textarea
                id="contact-message"
