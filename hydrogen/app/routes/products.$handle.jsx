      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div>
            ...
            <div className="mt-8">
              {/* Shipping */}
              <Accordion title="Shipping & Policy" defaultOpen>
                <div className="font-sans text-sm text-warm-gray leading-relaxed space-y-3">
                  ...
                  <p>All sales are final. Damaged or incorrect orders are replaced — contact us within 7 days of delivery.</p>
                </div>
              </Accordion>
...
function ProductBottleImage({product, bottleShadow}) {
  ...
  return (
    <div className="relative w-full">
      <img
        src="/images/bottle-neutral-v3.png"
        alt={product.name}
