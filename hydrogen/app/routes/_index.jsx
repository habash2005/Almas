...
export default function Homepage() {
  ...
  return (
    <>
      {/* ===== HERO ===== */}
      <section className="min-h-[92vh] flex flex-col md:flex-row items-center px-5 md:px-5 md:px-12 py-12 md:py-20 bg-light-gray relative overflow-hidden">
        <div className="flex-1 max-w-[560px] z-[2]">
          ...
          <p className="text-[15px] leading-[1.7] text-warm-gray max-w-[400px] mb-12 font-light">
            Luxury-inspired scents, meticulously crafted to capture the essence of the world&rsquo;s most coveted fragrances.
          </p>
      ...
      <section className="pt-20 px-5 md:px-12">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 min-h-[50vh] md:min-h-[70vh]">
        ...
        <div className="flex flex-col justify-center p-20">
          ...
          <p className="text-[15px] leading-[1.8] text-warm-gray max-w-[420px] mb-9 font-light">
            Almas — meaning diamond in Arabic — represents the pinnacle of craftsmanship. Each fragrance is meticulously composed to capture the DNA of the world&rsquo;s most beloved luxury scents.
          </p>
          <Link
            to="/our-story"
      ...
      {/* ===== NEW ARRIVALS ===== */}
      <section className="py-14 md:py-[100px] px-5 md:px-12 bg-light-gray">
        <div className="flex justify-between items-end mb-14">
          <div>
