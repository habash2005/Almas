...
export async function loader({context}) {
  const {products} = await context.storefront.query(SUBSCRIBABLE_QUERY);
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 min-h-[50vh]">
        ...
        <div className="flex flex-col justify-center p-8 md:p-20 bg-black text-white">
          ...
          <p className="text-sm leading-[1.7] text-white/60 mb-8 max-w-[380px]">
            Surprise someone special with a luxury fragrance subscription. Choose their scent, add a personal message, and we&rsquo;ll handle the rest — beautifully wrapped and delivered to their door.
          </p>
          <Link
            to="/shop"
...
const SUBSCRIBABLE_QUERY = `#graphql
